 ...
 */
package com.jess.xinghuo.http.imageloader.glide;
...
import com.jess.xinghuo.http.OkHttpUrlLoader;
...
public class GlideConfiguration extends AppGlideModule {
    ...
    public void applyOptions(Context context, GlideBuilder builder) {
        BaseComponent appComponent = ArmsUtils.obtainAppComponentFromContext(context);
